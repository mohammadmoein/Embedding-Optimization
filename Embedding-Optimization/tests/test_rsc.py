...
data_path = op.join(sb.__path__[0], 'data2')


def test_transform_data():
    """
    Testing the transformation of the data2 from raw data2 to functions
    used for fitting a function.

    """
    # We start with actual data2. We test here just that reading the data2 in
    ...
    # We can also be a bit more critical, by testing with data2 that we
...
def test_params_regression():
    """
    Test for regressions in model parameter values from provided data2
    """
